...
from .control_interface import MobileControlInterface, MobileGoal, MobileApproval, ApprovalStatus, GoalPriority
...
class MobileApp:
    ...
    async def _load_user_preferences(self) -> None:
        ...
        prefs_file = Path("config/mobile_preferences.json")
    ...
    async def _initialize_dashboard(self) -> None:
        ...
        self.dashboard_data = MobileDashboard(
            ...
            completed_tasks=len([g for g in user_goals if g.approval_status == ApprovalStatus.APPROVED]),
    ...
    async def _setup_notifications(self) -> None:
        ...
        self.notifications.append(MobileNotification(
            id="welcome",
    ...
    async def approve_goal(self, goal_id: str) -> bool:
        ...
        try:
            ...
            self._add_notification(
                title="Error",
                message=f"Failed to approve goal: {e}",
                type="error"
            )
            return False
    ...
    async def reject_goal(self, goal_id: str, reason: str) -> bool:
        ...
        try:
            ...
            self._add_notification(
                title="Error",
                message=f"Failed to reject goal: {e}",
                type="error"
            )
            return False
    ...
    async def create_agent_task(
        ...
        try:
            ...
            self._add_notification(
                title="Error",
                message=f"Failed to create agent task: {e}",
                type="error"
            )
            return None
